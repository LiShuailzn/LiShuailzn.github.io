...
现已在 CCF-A 类顶会 <span class="highlight">NeurIPS 2025、ICML 2026</span> 各获得一篇 <span class="highlight">Spotlight</span> 录用，另有一项研究工作投稿于 CCF-A 类期刊 <span class="highlight">IEEE TPAMI</span>。
以上研究均为科研前期阶段围绕演化多模态学习的基础研究。
